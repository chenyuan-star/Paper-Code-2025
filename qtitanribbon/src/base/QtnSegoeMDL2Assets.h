...
public:
    ...
    QPixmap pixmap(SegoeMDL2Font::IconSymbol symbol, const QColor& color = Qt::black);
    QPixmap pixmap(QChar code, const QColor& color = Qt::black);
    static QChar code(SegoeMDL2Font::IconSymbol symbol);
    static QPixmap pixmap(SegoeMDL2Font::IconSymbol symbol, const QSize& iconSize, const QColor& color = Qt::black);
    static QPixmap pixmap(QChar code, const QSize& iconSize, const QColor& color = Qt::black);
};
