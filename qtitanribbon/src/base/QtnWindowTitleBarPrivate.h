...
public:
    ...
    TitleBarAlign titleBarWidgetAlign() const;
    void setTitleBarWidgetAlign(TitleBarAlign align);
    bool hasFocus() const;
...
protected:
    ...
    virtual void nativeCommand(const QPoint& pos, Qt::WindowFrameSection frameSection) = 0;
...
protected:
    ...
    Qtitan::TitleBarAlign m_titleBarWidgetAlign;
    QRect m_textRect;
    ...
    bool m_maximized;
    bool m_fullScreen;
    TitleBarSysButtonKind m_sysButtonKind;
...
protected:
    ...
    virtual void processContextMenuEvent(QMouseEvent* event);
    virtual void resizeNonClientEvent(const QSize& windowSize);
    virtual void nativeCommand(const QPoint& pos, Qt::WindowFrameSection frameSection);
