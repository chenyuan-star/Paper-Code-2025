...
class QTITAN_BASE_EXPORT CommonStyleV5Private : public QObject
{
    Q_OBJECT
public:
...
public:
    ...
    virtual bool drawRibbonBackstageFrameMenu(const QStyleOption* opt, QPainter* painter, const QWidget* w = Q_NULL) const;
...
protected:
    ...
    void drawHighlightButton(const QStyleOption* option, QPainter* painter) const;
    void drawHighlightItemGallery(const QStyleOption* option, QPainter* painter) const;
    void drawButton(const QPixmap& px, const QStyleOption* option, QPainter* painter) const;
protected:
