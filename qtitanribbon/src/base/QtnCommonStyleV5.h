...
/* CommonStyleV5 */
class QTITAN_BASE_EXPORT CommonStyleV5 : public QProxyStyle
{
    Q_OBJECT
public:
    enum ContextColor
    ...
    enum QtnPixelMetric
    {
        PM_RibbonReducedGroupWidth = PM_CustomBase + 100,
    ...
    enum QtnPrimitiveElement
    {
        ...
        PE_PanelRibbonBar = PE_CustomBase + 100,
    ...
    {
        CE_RibbonTabShapeLabel = CE_CustomBase + 100,
        CE_RibbonTab,
        CE_RibbonTabBar,
        CE_RibbonGroupLabel,
    ...
    {
        CC_RibbonFileButton = CC_CustomBase + 100,
        CC_RibbonContextBar,
    ...
    enum QtnSubElement
    {
        SE_RibbonSysHeaderLabelPopupList = SE_CustomBase + 100,
    };

    /*! \internal */
    enum QtnStyleHint
    {
        SH_QtitanBegin = SH_CustomBase + 100,
    ...
    {
        SP_RibbonButtonPopupMenu = SP_CustomBase + 100,
