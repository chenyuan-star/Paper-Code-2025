...
EarthAutoClipPlaneCullCallback::EarthAutoClipPlaneCullCallback(MapNode* mapNode) :
_mapNode(mapNode),
_active(false),
//_minNearFarRatio     ( 0.00001 ),
//_maxNearFarRatio     ( 0.0005 ),
_minNearFarRatio(0.000001),
_maxNearFarRatio(0.05),
_haeThreshold(250.0),
_rp(-1),
_rp2(-1),
...
void EarthAutoClipPlaneCullCallback::operator()(osg::Node* node, osg::NodeVisitor* nv)
{
	if (_active)
	{
